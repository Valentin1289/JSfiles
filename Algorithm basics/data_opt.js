...
for (const x of movies) 
{
 ...
 if(x.year<1000)
{
    if(x.year<23) x.year+=2000;
    else x.year+=1000;
}
 for (y=0;y<x.actors.length;y++)
{
 allTheActors++;
 if(x.actors[y]=="Leonardo da Vinci") 
 x.actors[y]="Leonardo DiCaprio";
}
 for (y=0;y<x.genres.length;y++)  
{
    if(x.genres[y]=="") 
    x.genres[y]+="Drama"; 
}
